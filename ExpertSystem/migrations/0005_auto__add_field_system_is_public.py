...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'System.is_public'
        db.add_column('system', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'System.is_public'
        db.delete_column('system', 'is_public')
    ...
    models = {
        ...
        u'ExpertSystem.system': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

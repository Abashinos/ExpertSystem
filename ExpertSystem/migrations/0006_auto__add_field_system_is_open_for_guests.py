...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'System.is_open_for_guests'
        db.add_column('system', 'is_open_for_guests',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'System.is_open_for_guests'
        db.delete_column('system', 'is_open_for_guests')
    ...
    models = {
        ...
        u'ExpertSystem.system': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
